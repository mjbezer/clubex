                    ...
                    <form method="post" action="/associete/store" class="form-horizontal">
                        ...
                        <div class="form-row">
                            <div class="form-group-custom col-md-4">
                                <input type="text" id="cpf_cnpj" name="cpf_cnpj" parsley-trigger="change" required
                                    value="@isset($associado){{$associado->cpf_cnpj }}@endisset" />
                                <label class="control-label">CPF/CNPJ</label><i class="bar"></i>
                            </div>
                            <div class="form-group-custom col-md-4">
                                <input type="date" id="data_abertura" name="data_abertura" parsley-trigger="change"
                                    required value="@isset($associado){{$associado->data_abertura }}@endisset" />
